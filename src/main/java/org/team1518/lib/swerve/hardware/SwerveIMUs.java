package org.team1518.lib.swerve.hardware;
...
import org.team1518.lib.logging.phoenix.Pigeon2Logger;
import org.team1518.lib.logging.reduxlib.CanandgyroLogger;
import org.team1518.lib.logging.studica.NavXLogger;
import org.team1518.lib.logging.wpilibj.ADIS16470Logger;
import org.team1518.lib.swerve.SwerveAPI;
import org.team1518.lib.swerve.config.SwerveConfig;
import org.team1518.lib.swerve.hardware.SwerveIMUs.SwerveIMU.IMUSimHook;
import org.team1518.lib.util.Math2;
    ...
    public static SwerveIMU.Ctor navx(AHRS.NavXComType port) {
        return config -> {
            ...
            return new SwerveIMU() {
                ...
                @Override
                public void log(EpilogueBackend backend, ErrorHandler errorHandler) {
                    deviceLogger.tryUpdate(backend, navx, errorHandler);
                }
